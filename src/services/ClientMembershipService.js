...
module.exports = {
    ...
    getAll: async (req, res, next) => {
        ...
        const query = 'SELECT cl.id, cm.client_id,cm.membership_id, cl.first_name, cl.last_name,cl.phone_no,cl.location,cl.user_id,u.email FROM client_membership cm inner join clients cl on cm.client_id = cl.id inner join users u on cl.user_id = u.id'
